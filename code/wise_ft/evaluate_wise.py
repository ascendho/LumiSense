#!/usr/bin/env python3
"""Evaluate a WiSE-FT interpolated adapter on CARES splits."""
...
from lumisense_wise.data_io import load_pairs, select_balanced_pairs, write_jsonl
from lumisense_wise.metrics import score_predictions
from lumisense_wise.prompt import inference_messages
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a WiSE-FT adapter on train or validation.")
